...
export default function CompaniesList() {
  return (
    <div className="relative flex h-auto w-full flex-col justify-between  overflow-x-hidden">
      <div>
        <div className="flex items-center gap-4 px-6 min-h-[68px] justify-between cursor-pointer hover:bg-slate-50 transition-all duration-100">
        ...
        <div className="flex items-center gap-4 px-6 min-h-[68px] justify-between border-t border-t-gray-200 cursor-pointer hover:bg-slate-50 transition-all duration-100">
          <div className="flex flex-col justify-center">
            <p className="font-medium leading-normal line-clamp-1">
              Verde Futuro S.A.
            </p>
